...
import Crousaldetail from "./Crousaldetail";
                    ...
                    <div className="display_flexx_services">
                      {Array(7)
                        ...
                        .map((item: any, index: number) => (
                          <div
                            key={index}
                            className="catagories_width text-center"
                          >
                            <Image
                              className="img-fluid "
                              alt="image"
                          ...
                          <div className="row">
                            ...
                            <div className="col-md-7 pt-2">
                              ...
                              <p className="font_size_2 mb-0 pb-0">
                                From{" "}
                                <b className="font_size_3">{item.priceFrom}</b>
                              </p>
                              ...
                              <div className="col-md-12 text-end">
                                <div className="col-md-12 text-end">
                                  ...
                                  <h6 className="px-1 position_top">
                                    {item.price}{" "}
                                    <p className="save_text px-2"> Save</p>
                                  </h6>
                                </div>
                                <button
                          ...
                          <div className="col-md-12 bcakground_color_card pt-1 pb-1">
                            <div className="row">
                              <div className="col-md-2 text-center">
                                <img
                                  className="img-fluid"
                                  src="/imagess/starr.png"
                                />
                              </div>
                              <div className="col-md-10">
                                <p className="mb-0 pb-0 save_text1">{item}</p>
                                <p className="mb-0 pb-0 get_now_text1">
                                  Get now
                                </p>
                              </div>
                            </div>
                      ...
                      <div className="col-md-6" key={index}>
                        <div className="row">
                          ...
                          <div className="col-md-9">
                            <h6 className="main_heading_service">
                              Laser Vein Removal
                            </h6>
                            <h6 className="sub_heading_service">
                              We have years of experience in repairing all
