...
const CreateAndUpdateAddress = ({
    ...
    useEffect(() => {
        const getAddressName: any = localStorage.getItem("addressMain");
        const getAddressJson: any = localStorage.getItem("addressJson");
        const parsedvalue: any = JSON.parse(getAddressJson);
        const getAddressNameParsed: any = JSON.parse(getAddressName);
        // console.log("address",parsedvalue)
        setAddressName(getAddressNameParsed?.formatted)
        // setCity(`${JSON.parse(getAddressJson)}`)
        ...
        setLat(`${parsedvalue?.geometry?.lat}`)
        setLog(`${parsedvalue?.geometry?.lng}`)
        // console.log("anas", parsedvalue?.components?.district)
    }, [])
