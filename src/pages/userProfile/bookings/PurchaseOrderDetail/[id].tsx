...
function PurchaseOrderDetail() {
  ...
  const salesorderwithidd = async (storedId: any) => {
    ...
    try {
      const response = await axios.get(
        `https://gateway.findanexpert.net/purchaseorder_svc/pb/getPurchaseOrderById/?PurchaseOrderId=${storedId}&timeZone=Europe/London`,
        { headers }
      );
      // setData(response.data?.result?.outPutSectionModels);
      console.log("SEO page api data", response.data.result);
      setBookingbyid(response.data?.result?.data)
      setPurschaseOrderId(response?.data?.result?.purchaseOrderId);
      setAddress(response?.data?.result?.address?.dropOffAddress[0])
  ...
  console.log("mmmmmmmmm", addresss)
                  ...
                  <div className="row pt-3">
                    ...
                    <div className="col-md-6 mt-2">
                      <div className="row">
                        ...
                        <div className="col-md-10 col-9 pe-0 m-auto">
