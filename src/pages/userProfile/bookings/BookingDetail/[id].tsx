...
function BookingDetail() {
  ...
  useEffect(() => {
    if (storedId) {
      BookingDetail(parseInt(storedId));
    }
  }, [storedId]);
  ...
  const BookingDetail = async (storedId: any) => {
    ...
    try {
      const response = await axios.get(
        ...
        `https://gateway.findanexpert.net/bookingorder_svc/pb/getBookingById/?bookingId=${storedId}&timeZone=Europe/London`,
        { headers }
      );
            ...
            <div className="col-md-12 background_sidenav_one padding_bottom_boking">
              ...
              <div className="col-md-12 padding_left_right1 ">
                <div className="col-md-12 border_booking pb-3 px-3">
                  ...
                  <div className="row ">
                    <div className="col-md-2 m-auto"><i className="fas fa-angle-double-left"></i></div>
                    <div className="col-md-8">
                      <div className="flex_using_booking_d">

                        <div className="light_b mx-1">
                    ...
                    <div className="col-md-2 text-end m-auto"><i className="fas fa-angle-double-right"></i></div>
                  </div>
                  <div className="col-md-12">
                    <hr className="background_line" />
                  </div>
                  ...
                  <div className="row pt-3">
                    ...
                    <div className="col-md-6 mt-2">
                      <div className="row">
                        ...
                        <div className="col-md-10 m-auto">
                          <p className="m-0 p-0 heading_frinkle">sss</p>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-6 text-end m-auto">
