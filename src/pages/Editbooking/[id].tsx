...
const Editbookings = () => {
    ...
    useEffect(() => {
        ...
        if (id && bookingnulllocal) {
            ...
            const matchingAppointment = appointments.find((appointment: any) => appointment.expertAppointmentId === parseInt(id, 10));
    ...
    // console.log("SelectedAppointment", bookingnulllocal?.attributes[0]?.attributeSku)

    const flowAndPurchaseOrderHandler = async () => {
        setLoadingnew(true)
        const requestData = {
            ...
            // sku: bookingnulllocal?.serviceSKU,
    ...
    //         customerId: profile?.externalCustomerId,
    //         providerId: bookingnulllocal?.providerId,
    //         plexaarAppointmentId: SelectedAppointment?.plexaarAppointmentId,
    //         expertAppointmentId: SelectedAppointment?.expertAppointmentId,
    //         sku: bookingnulllocal?.serviceSKU,
    //         oldDate: {
    ...
    console.log("bookingdetailforbookingnull",bookingnulllocal?.hasattribute === "true")
                    ...
                    <div className="col-md-12 ">
                        ...
                        <div className="row on_pc_screeen">
                            <div className="col-md-12">
                                ...
                                <div className="col-md-12 border_slots_calender px-3 py-2">
                                    <div className="calendar ">
                                        ...
                                        <div className="d-flex">
                                            <span className=" pt-3" onClick={scrollLeft}><img className="img-fluid img_pointer" src="/imagess/left-simple.png" /></span>
                                            {/* {showhide === true ? null :
                                            ...
                                            <div className="calendar-days_pc ps-4 pt-2 pb-2" ref={calendarRef} >{generateCalendarpc()}</div>
                                            <span className="ps-3 pe-2 pt-3" onClick={scrollRight}><img className="img-fluid img_pointer" src="/imagess/right-simple.png" /></span>
                                        </div>
